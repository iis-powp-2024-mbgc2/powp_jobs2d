...
import edu.kis.powp.jobs2d.customLines.CustomizableLine;
...
public class TestJobs2dPatterns {
	...
	private static void setupPresetTests(Application application) {
		...
		application.addTest("Test Figure 1", selectTestFigureOptionListener3);
		application.addTest("Test Figure 2", selectTestFigureOptionListener4);
		application.addTest("Test Figure 3", selectTestFigureOptionListener5);
	}
	...
	private static void setupDrivers(Application application) {
		...
		Job2dDriver testLineDriver = new LineDrawerAdapter(LineFactory.getSpecialLine());
		DriverFeature.addDriver("Special Line Simulator", testLineDriver);

		CustomizableLine customizableLine = new CustomizableLine();
		customizableLine.setIsDotted(true);
		customizableLine.setColor(Color.green);
		customizableLine.setThickness(4.0F);
		Job2dDriver testCustomLineDriver = new LineDrawerAdapter(customizableLine);
		DriverFeature.addDriver("Custom Line Simulator", testCustomLineDriver);
