...
public class CommandFactory {
    public static ComplexCommand createRectangle(Job2dDriver driver,int x, int y,int a, int b)
    {
        ...
        com.addCommand(new OperateToCommand(driver, x, y+b));
        com.addCommand(new OperateToCommand(driver, x, y));

        return com;
    }

    public static ComplexCommand createSquare(Job2dDriver driver, int x, int y, int a)
    {
        ComplexCommand com = new ComplexCommand();
